...
Track which user last modified each card. With shared boards, multiple users may interact with the same cards. Recording the last modifier provides accountability and context for collaborators.

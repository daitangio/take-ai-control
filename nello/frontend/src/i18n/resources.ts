...
export const resources = {
  en: {
    translation: {
      ...
      list: {
        ...
        archive: 'Delete everything',
        archiveConfirm: 'Delete list "{{name}}" and all its cards ?',
  ...
  it: {
    translation: {
      ...
      list: {
        ...
        archive: 'Elimina tutto',
        archiveConfirm: 'Eliminare la lista "{{name}}" e tutte le sue card?',
  ...
  es: {
    translation: {
      ...
      list: { dragAria: 'Arrastrar lista', actionsAria: 'Acciones de la lista {{name}}', actionsMenuAria: 'Acciones para {{name}}', showArchived: 'Mostrar elementos archivados', archive: 'Eliminar todo', archiveConfirm: '¿Eliminar la lista "{{name}}" y todas sus tarjetas?', enterTitle: 'Introduce el título de la tarjeta...', addCard: 'Añadir tarjeta', addCardButton: '+ Añadir tarjeta' },
